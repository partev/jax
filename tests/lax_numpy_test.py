...
class NumpySignaturesTest(jtu.JaxTestCase):
  ...
  def testWrappedSignaturesMatch(self):
    ...
    _UFUNC_ARGS = ['out', 'where', 'casting', 'order', 'dtype', 'subok', 'signature']
    # For binary ufuncs that support out/where but take *args (hiding x1/x2):
    _UFUNC_ARGS_BINARY = ['x1', 'x2', 'casting', 'order', 'dtype', 'subok', 'signature']
    # For unary ufuncs that support out/where but take *args (hiding x):
    _UFUNC_ARGS_UNARY = ['x', 'casting', 'order', 'dtype', 'subok', 'signature']

    unsupported_params = {
      'abs': _UFUNC_ARGS,
      'absolute': _UFUNC_ARGS,
      'acos': _UFUNC_ARGS,
      'acosh': _UFUNC_ARGS,
      'add': _UFUNC_ARGS_BINARY,
      ...
      'array': ['subok', 'ndmax', 'like'],
      # TODO(dsuo): copy and dtype are out of order.
      'asarray': ['copy', 'dtype', 'like'],
      'asin': _UFUNC_ARGS,
      'asinh': _UFUNC_ARGS,
      'atan': _UFUNC_ARGS,
      'atan2': _UFUNC_ARGS,
      'atanh': _UFUNC_ARGS,
      'bitwise_and': _UFUNC_ARGS_BINARY,
      'bitwise_count': _UFUNC_ARGS,
      'bitwise_invert': _UFUNC_ARGS,
      'bitwise_left_shift': _UFUNC_ARGS + ['x1', 'x2'],
      'bitwise_not': _UFUNC_ARGS,
      'bitwise_or': _UFUNC_ARGS_BINARY,
      'bitwise_right_shift': _UFUNC_ARGS,
      'bitwise_xor': _UFUNC_ARGS_BINARY,
      'broadcast_to': ['subok'],
      'cbrt': _UFUNC_ARGS,
      'ceil': _UFUNC_ARGS,
      'clip': ['kwargs', 'out'],
      ...
      'conj': _UFUNC_ARGS,
      'conjugate': _UFUNC_ARGS,
      'copy': ['subok'],
      'copysign': _UFUNC_ARGS,
      'corrcoef': ['ddof', 'bias'],
      'cos': _UFUNC_ARGS,
      'cosh': _UFUNC_ARGS,
      'cumulative_prod': ['out'],
      ...
      'equal': _UFUNC_ARGS + ['x1', 'x2'],
      'exp': _UFUNC_ARGS,
      'exp2': _UFUNC_ARGS,
      'expm1': _UFUNC_ARGS,
      'eye': ['order', 'like'],
      'fabs': _UFUNC_ARGS,
      'float_power': _UFUNC_ARGS + ['x1', 'x2'],
      'floor': _UFUNC_ARGS,
      'floor_divide': _UFUNC_ARGS,
      'fmax': _UFUNC_ARGS,
      'fmin': _UFUNC_ARGS,
      'fmod': _UFUNC_ARGS,
      'frexp': _UFUNC_ARGS,
      ...
      'gcd': _UFUNC_ARGS,
      'greater': _UFUNC_ARGS + ['x1', 'x2'],
      'greater_equal': _UFUNC_ARGS + ['x1', 'x2'],
      'heaviside': _UFUNC_ARGS,
      'hstack': ['casting'],
      'hypot': _UFUNC_ARGS,
      'identity': ['like'],
      'invert': _UFUNC_ARGS,
      'isfinite': _UFUNC_ARGS,
      'isin': ['kind'],
      'isinf': _UFUNC_ARGS,
      'isnan': _UFUNC_ARGS,
      'lcm': _UFUNC_ARGS,
      'ldexp': _UFUNC_ARGS,
      'left_shift': _UFUNC_ARGS + ['x1', 'x2'],
      'less': _UFUNC_ARGS + ['x1', 'x2'],
      'less_equal': _UFUNC_ARGS + ['x1', 'x2'],
      'load': ['mmap_mode', 'allow_pickle', 'fix_imports', 'encoding', 'max_header_size'],
      'log': _UFUNC_ARGS,
      'log10': _UFUNC_ARGS,
      'log1p': _UFUNC_ARGS,
      'log2': _UFUNC_ARGS,
      'logaddexp': _UFUNC_ARGS_BINARY,
      'logaddexp2': _UFUNC_ARGS_BINARY,
      'logical_and': _UFUNC_ARGS_BINARY,
      'logical_not': _UFUNC_ARGS,
      'logical_or': _UFUNC_ARGS_BINARY,
      'logical_xor': _UFUNC_ARGS_BINARY,
      'matmul': _UFUNC_ARGS + ['x1', 'x2', 'axes', 'axis', 'keepdims'],
      'matvec': _UFUNC_ARGS + ['axes', 'axis', 'keepdims'],
      'maximum': _UFUNC_ARGS_BINARY,
      'minimum': _UFUNC_ARGS_BINARY,
      'mod': _UFUNC_ARGS,
      'modf': ['where', 'casting', 'order', 'dtype', 'subok', 'signature'],
      'multiply': _UFUNC_ARGS_BINARY,
      'nanpercentile': ['weights'],
      'nanquantile': ['weights'],
      'nanstd': ['correction'],
      'nanvar': ['correction'],
      'negative': _UFUNC_ARGS_UNARY,
      'nextafter': _UFUNC_ARGS + ['x1', 'x2'],
      'not_equal': _UFUNC_ARGS + ['x1', 'x2'],
      'ones': ['order', 'like'],
      'ones_like': ['subok', 'order'],
      'partition': ['kind', 'order'],
      'percentile': ['weights'],
      'positive': _UFUNC_ARGS,
      'pow': _UFUNC_ARGS,
      'power': _UFUNC_ARGS,
      ...
      'rad2deg': _UFUNC_ARGS,
      'radians': _UFUNC_ARGS,
      'reciprocal': _UFUNC_ARGS,
      'remainder': _UFUNC_ARGS,
      'right_shift': _UFUNC_ARGS,
      'rint': _UFUNC_ARGS,
      'row_stack': ['casting'],
      'sign': _UFUNC_ARGS,
      'signbit': _UFUNC_ARGS,
      ...
      'square': _UFUNC_ARGS,
      'stack': ['casting'],
      'subtract': _UFUNC_ARGS_BINARY,
      'tan': _UFUNC_ARGS,
      'tanh': _UFUNC_ARGS,
      'tri': ['like'],
      'true_divide': _UFUNC_ARGS,
      'trunc': _UFUNC_ARGS,
      'unravel_index': ['order'],
      'vecdot': _UFUNC_ARGS + ['axes', 'keepdims'],
      'vecmat': _UFUNC_ARGS + ['axes', 'axis', 'keepdims'],
      'vstack': ['casting'],
      'zeros': ['order', 'like'],
    ...
    extra_params = {
      'add': ['args'],
      'arange': ['start', 'out_sharding'],
      'array': ['out_sharding'],
      'asarray': ['out_sharding'],
      'bitwise_and': ['args'],
      'bitwise_or': ['args'],
      'bitwise_xor': ['args'],
      'compress': ['size', 'fill_value'],
      'dot': ['precision', 'preferred_element_type', 'out_sharding'],
      ...
      'logical_or': ['args'],
      'logical_xor': ['args'],
      'matmul': ['precision', 'preferred_element_type', 'out_sharding'],
      'maximum': ['args'],
      'minimum': ['args'],
      'multiply': ['args'],
      'negative': ['args'],
      ...
      'vecdot': ['precision', 'preferred_element_type'],
      'zeros': ['out_sharding']
    }
